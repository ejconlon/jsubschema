...
public class PropertiesEmail implements Cloneable, Serializable, PropertiesEmailLike {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PropertiesEmail{ ");
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof PropertiesEmailLike) {
            PropertiesEmailLike other = (PropertiesEmailLike) o;
    ...
    public Set<String> diff(PropertiesEmailLike other) {
